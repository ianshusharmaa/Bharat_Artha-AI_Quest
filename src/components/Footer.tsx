...
const Footer = () => {
  ...
  return (
    <footer className="bg-white/80 backdrop-blur-md border-t border-indigo-100 shadow-inner p-6 text-center mt-auto">
      <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-4">
        <span className="text-[var(--foreground)] opacity-70">
          © 2026 {language === 'hi' ? 'भारत अर्थ-AI Quest' : 'Bharat Arth-AI Quest'}
        </span>
